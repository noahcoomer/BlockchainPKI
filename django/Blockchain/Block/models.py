...
class Block(models.Model):
    ...
    hashValue = models.CharField(max_length=350)
    merkleRoot = models.CharField(max_length=350)
    version = models.CharField(max_length=5)
    previousHash = models.CharField(max_length=350)
    timestamp = models.CharField(max_length=120)
    tCounter = models.IntegerField()
